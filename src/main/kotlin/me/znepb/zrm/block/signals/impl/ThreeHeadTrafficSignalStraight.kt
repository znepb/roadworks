...
class ThreeHeadTrafficSignalStraight(settings: Settings)
    : AbstractThreeHeadSignal<ThreeHeadTrafficSignalStraightBlockEntity>
    (settings, ::ThreeHeadTrafficSignalStraightBlockEntity) {
