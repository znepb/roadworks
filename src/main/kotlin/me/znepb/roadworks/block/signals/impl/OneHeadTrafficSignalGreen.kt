...
class OneHeadTrafficSignalGreen(settings: Settings)
    : AbstractOneHeadSignal<OneHeadTrafficSignalGreenBlockEntity>
    (settings, ::OneHeadTrafficSignalGreenBlockEntity) {
