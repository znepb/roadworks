...
abstract class AbstractOneHeadSignal<T: AbstractTrafficSignalBlockEntity>
...
{
    companion object {
        val SIGNAL_SHAPE_WALL = createCuboidShape(5.0, 5.0, 15.0, 11.0, 11.0, 16.0)
        val SIGNAL_SHAPE_POST_NONE = createCuboidShape(5.0, 5.0, 7.0, 11.0, 11.0, 8.0)
