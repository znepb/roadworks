...
class LanguageProvider(output: FabricDataOutput) : FabricLanguageProvider(output) {
    override fun generateTranslations(translationBuilder: TranslationBuilder) {
        ...
        translationBuilder.add("sign.${NAMESPACE}.3_way_intersection_rail_left", "3-Way Intersection Sign Left w/ Rail")
        translationBuilder.add("sign.${NAMESPACE}.3_way_intersection_rail_right", "3-Way Intersection Sign Right w/ Rail")
        translationBuilder.add("sign.${NAMESPACE}.3_way_intersection_rail_t", "3-Way Intersection Sign T w/ Rail")
        ...
        translationBuilder.add("sign.${NAMESPACE}.4_way_intersection_rail_right", "4-Way Intersection Sign w/ Rail Right")
        translationBuilder.add("sign.${NAMESPACE}.4_way_intersection_rail_left", "4-Way Intersection Sign w/ Rail left")
        ...
        translationBuilder.add("sign.${NAMESPACE}.rail_intersection_diag", "Diagonal Rail Intersection Sign")
        translationBuilder.add("sign.${NAMESPACE}.rail_intersection_diag_alt", "Diagonal Rail Intersection Sign Alternate")
        ...
        translationBuilder.add("sign.${NAMESPACE}.2_tracks", "2 Tracks Sign")
        translationBuilder.add("sign.${NAMESPACE}.3_tracks", "3 Tracks Sign")
        translationBuilder.add("sign.${NAMESPACE}.4_tracks", "4 Tracks Sign")
        translationBuilder.add("sign.${NAMESPACE}.keep_left", "Keep Left Sign")
        translationBuilder.add("sign.${NAMESPACE}.keep_left_alt", "Keep Left Sign (Alternate)")
        translationBuilder.add("sign.${NAMESPACE}.keep_right", "Keep Right Sign")
        translationBuilder.add("sign.${NAMESPACE}.keep_right_alt", "Keep Right Sign (Alternate)")
        translationBuilder.add("sign.${NAMESPACE}.left_lane_ends_ahead", "Left Lane Ends Ahead Sign")
        translationBuilder.add("sign.${NAMESPACE}.left_turn_yield_on_green", "Left Turn Yield on Green Sign")
        translationBuilder.add("sign.${NAMESPACE}.no_turn_on_red", "No Turn On Red Sign")
        translationBuilder.add("sign.${NAMESPACE}.no_turn_on_red_alt", "No Turn On Red Sign (Alternate 1)")
        translationBuilder.add("sign.${NAMESPACE}.no_turn_on_red_alt_2", "No Turn On Red Sign (Alternate 2)")
        translationBuilder.add("sign.${NAMESPACE}.object_marker", "Object Marker")
